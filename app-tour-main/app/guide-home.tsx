...
const RECENT_ACTIVITIES = [
  {
    ...
    color: "#16a34a",
    text: "Tour Núi Bà Đen hoàn thành",
    time: "2 giờ trước",
  },
  {
    icon: "calendar" as const,
    color: "#2856d6",
    text: "Booking mới từ Trần Thị B",
    time: "5 giờ trước",
  },
  {
    icon: "star" as const,
    color: "#f59e0b",
    text: "Nhận đánh giá 5⭐ từ khách",
    time: "Hôm qua",
  },
  {
    icon: "cash" as const,
    color: "#16a34a",
    text: "Thanh toán 3.600.000đ nhận được",
    time: "2 ngày trước",
  },
];
...
export default function GuideHome() {
  ...
  useEffect(() => {
    ...
    AsyncStorage.getItem("@guide_bookings")
      .then((raw) => {
        if (raw) {
          const data = JSON.parse(raw);
          setPendingBookings(
            data.filter((b: any) => b.status === "pending").length,
          );
        }
      })
      .catch(() => {});
    // Load unread notifications count
    AsyncStorage.getItem("@guide_notifications")
      .then((raw) => {
        if (raw) {
          const data = JSON.parse(raw);
    ...
    <View style={styles.root}>
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push("/guide-notifications" as any)}
          >
        ...
        <View style={styles.heroBanner}>
          <View style={styles.heroTextCol}>
            ...
            <TouchableOpacity
              ...
              onPress={() => router.push("/guide-booking-management" as any)}
            >
        ...
        <View style={styles.statsGrid}>
          {[
            ...
            >
              <View
                style={[styles.statIconCircle, { backgroundColor: item.color }]}
              >
        ...
        <View style={styles.infoCards}>
          <View style={styles.infoCard}>
            <View style={styles.infoIconWrap}>
              <Ionicons name="briefcase-outline" size={20} color="#2856d6" />
            </View>
            <View>
        ...
        <View style={styles.quickGrid}>
          {QUICK_ACTIONS.map((qa, i) => (
            ...
            >
              ...
              <Text style={[styles.quickLabel, { color: qa.color }]}>
                {qa.label}
              </Text>
            </TouchableOpacity>
          ))}
          ...
          return (
            ...
            >
              ...
              >
                ...
                />
                {i === 1 && pendingBookings > 0 && (
                  <View style={styles.tabBadge}>
                    <Text style={styles.tabBadgeTxt}>{pendingBookings}</Text>
                  </View>
                )}
              </View>
      ...
      >
        <View style={[styles.drawerHeader, { paddingTop: insets.top + 24 }]}>
          ...
          <View style={styles.drawerBadge}>
            <Text style={styles.drawerBadgeText}>HDV Đã xác minh</Text>
          </View>
        </View>
        <ScrollView
        ...
        >
          {DRAWER_ITEMS.map((item, i) => (
            <TouchableOpacity
              ...
              onPress={() => {
                closeDrawer();
                if (i !== 0) router.push(item.route as any);
              }}
              activeOpacity={0.75}
            >
              <View
              ...
              {i === 5 && unreadCount > 0 && (
                <View style={styles.drawerBadgeCount}>
                  <Text style={styles.drawerBadgeCountTxt}>{unreadCount}</Text>
                </View>
              )}
      ...
      >
        {(
          ...
          const isActive = tab.route === "/guide-home";
          return (
            <TouchableOpacity
              key={tab.route}
              style={tabSt.item}
