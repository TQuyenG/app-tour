    ...
    <View style={styles.container}>
          ...
          <View style={styles.bookingStatusRow}>
            {[
              ...
              <View key={item.label} style={styles.bookingStatusCard}>
                <View
                  style={[styles.bookingDot, { backgroundColor: item.color }]}
                />
                <Text style={styles.bookingValue}>{item.value}</Text>
                <Text style={styles.bookingLabel}>{item.label}</Text>
                <Text style={[styles.bookingPct, { color: item.color }]}>
                  {item.pct}
                </Text>
              </View>
            ))}
      ...
      >
        {[
          ...
          const isActive = tab.route === "/admin-report";
          return (
            <TouchableOpacity
              key={tab.route}
...
const styles = StyleSheet.create({
  ...
  // Add tabBar styles for admin bottom menu
  tabBar: {
    backgroundColor: "#fff",
    flexDirection: "row",
    alignItems: "center",
